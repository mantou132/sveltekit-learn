<script lang="ts">
  ...
  import type { DuoyunColorPickElement } from "duoyun-ui/svelte/color-picker";

  let colorElement: DuoyunColorPickElement | undefined;
  let cardActions = [
...
<div>
  <dy-paragraph>
    <dy-space>
      <dy-button
        on:click={() => colorElement?.showPicker()}
      >
        Open Color Picker
      </dy-button>
      <dy-color-picker
